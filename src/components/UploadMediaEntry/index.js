...
class UploadMediaComponent extends React.Component {
  ...
  TitleChanged(e){
    ...
    newmediainfo.Title = e.target.value;
  ...
  VersionChanged(e){
    ...
    console.log(e.target.value);
    var newmediainfo = this.state.mediaInfo;
    newmediainfo.Version = e.target.value;
    this.setState({mediaInfo:newmediainfo});
  }


  VersionDescriptionChanged(e){

    console.log(e.target.value);
    var newmediainfo = this.state.mediaInfo;
    newmediainfo.VersionDescription = e.target.value;
    this.setState({mediaInfo:newmediainfo});
  }
  ...
  DescriptionChanged(e){
    ...
    console.log(e.target.value);
    var newmediainfo = this.state.mediaInfo;
    newmediainfo.Description = e.target.value;
    this.setState({mediaInfo:newmediainfo});
  }
  ...
  render() { 
    return ( 
      ...
      <g id="n" className="b">
        <rect className="c" width={1198} height={953} />
        <rect className="c" width={1194} height={950} rx={4} />
        <g transform="translate(34 29)">
          <text className="d" transform="translate(0 419)">
            <tspan x={0} y={13}>
              {
                "Learn more about uploading in the Video Guidelines, Compression Guidelines, and "
              }
            </tspan>
            <tspan x={0} y={33}>
              {"Help Center."}
...
{/*   
  <text className="j" transform="translate(16 11)">
      ...
      <textarea className="MediaEntryInput-MediaMultiLine" rows="6" cols="36" onChange={this.DescriptionChanged}></textarea>
              ...
              <text className="j" transform="translate(16 214)">
                <tspan x={0} y={0}>
      ...
      <textarea className="MediaEntryInput-MediaMultiLine" rows="6" cols="36" onChange={this.VersionDescriptionChanged}></textarea>
              ...
              <text className="j" transform="translate(16 214)">
                <tspan x={0} y={0}>
                  {"Description of the updates made to this version."}
                </tspan>
              </text>
              <rect
                className="c"
          ...
          <g transform="translate(0 468)">
            <g className="h" transform="translate(0 8)">
              <rect className="ae" width={191} height={116} rx={4} />
              <rect className="a" x={1} y={1} width={189} height={114} rx={3} />
            </g>
            <rect
              className="c"
              width={77}
...
{/*               
            ...
            <g transform="translate(0 415)">
              ...
              <g className="s" transform="translate(18 70)">
                <g transform="translate(-18 -68)">
                  <g transform="translate(18 68)">
                    <g className="t">
                      <rect className="ae" width={72} height={32} rx={16} />
                      <rect
                        className="a"
                        x={0.5}
                        y={0.5}
                    ...
                    <text className="u" transform="translate(10 20)">
                      <tspan x={0} y={0}>
                        {"VFX"}
                      </tspan>
                    </text>
                    <g className="m" transform="translate(52 11)">
                      <rect className="a" width={11} height={11} />
                      <path
                        className="v"
                        d="M149.139-15.638l-.777.777-1.973-1.973-1.973,1.973-.777-.777,1.973-1.973-1.973-1.973.777-.777,1.973,1.973,1.973-1.973.777.777-1.973,1.973Zm-2.75-7.473a5.5,5.5,0,0,0-5.5,5.5,5.5,5.5,0,0,0,5.5,5.5,5.5,5.5,0,0,0,5.5-5.5,5.5,5.5,0,0,0-5.5-5.5Z"
            ...
            <rect
              ...
              transform="translate(11 6)"
            />
            <text className="w" transform="translate(17 11)">
              <tspan x={0} y={0}>
                {"Storage"}
              </tspan>
            </text>
            ...
            <text className="z" transform="translate(17 35)">
              <tspan x={0} y={0}>
                {"32 GB / 100 GB"}
              </tspan>
            </text>
            <text className="z" transform="translate(335 35)">
              <tspan x={-74.86} y={0}>
                {"5$ USD / Month"}
              </tspan>
            </text>
