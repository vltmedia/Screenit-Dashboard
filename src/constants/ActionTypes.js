...
//Screenit const
export const SCREENIT_USER = 'screenit_user';
export const SCREENIT_CLIENT = 'screenit_client';
export const SCREENIT_PROJECT = 'screenit_project';
export const SCREENIT_MEDIAENTRY = 'screenit_mediaentry';
export const SCREENIT_MEDIAENTRY_SET = 'screenit_mediaentry_set';
export const SCREENIT_PUBLICLINK = 'screenit_publiclink';
export const SCREENIT_UPDATECURRENTTIME = 'screenit_updatecurrenttime';
