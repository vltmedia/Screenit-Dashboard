...
const App = (props) => {
  ...
  // var pathh = "http://67.205.187.138:1340/auth/local";
  // var templatesigning = {
  //     identifier: "VLTMediaDEV",
  //     password: "0528Screenit"
  // }
  // axios.post(pathh, templatesigning)
  //   .then((response) => {
  //     console.log(response);
  //     console.log(response.data);
  //     this.setState({signinginfo:response.data, singedin:true});
  //     this.PostSignIn();
  //   }, (error) => {
  //     console.log(error);
